...
OutputDir=.
OutputBaseFilename=mzimeja-0.2-setup
Compression=lzma
...
Source: "kanji_table.dat"; DestDir: "{app}"; Flags: ignoreversion
Source: "radical_table.dat"; DestDir: "{app}"; Flags: ignoreversion
